...
public class FooLocalServiceClp implements FooLocalService {
    ...
    public me.rkg.plugins.model.Foo addFoo(me.rkg.plugins.model.Foo foo)
        ...
        return (me.rkg.plugins.model.Foo) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<me.rkg.plugins.model.Foo> getFoos(int start, int end)
        ...
        return (java.util.List<me.rkg.plugins.model.Foo>) ClpSerializer.translateOutput(returnObj);
    }
