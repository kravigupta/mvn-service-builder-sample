...
import me.rkg.plugins.model.FooModel;
import me.rkg.plugins.model.FooSoap;
...
/**
 * The base model implementation for the Foo service. Represents a row in the &quot;RKG_Foo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link me.rkg.plugins.model.FooModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link FooImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see FooImpl
 * @see me.rkg.plugins.model.Foo
 * @see me.rkg.plugins.model.FooModel
 * @generated
 */
@JSON(strict = true)
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a foo model instance should use the {@link me.rkg.plugins.model.Foo} interface instead.
     */
    public static final String TABLE_NAME = "RKG_Foo";
